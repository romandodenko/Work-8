...
<head>
  ...
  <meta property="og:title" content="Sport birr în chile cu transmisiuni sportive pe macarale mari. Partidos">
  ...
  <meta name="twitter:title" content="Sport birr în chile cu transmisiuni sportive pe macarale mari. Partidos">
  ...
  <meta name="description"
    content="Barul de sport este situat în inima Chile și se află pe primul loc printre locațiile sportive datorită serviciilor sale excelente și atmosferei de neegalat.">
  <title>Sport birr în chile cu transmisiuni sportive pe macarale mari. Partidos</title>
...
<body>
  <div class="page">
    ...
    <main>
      <!-- start partidos -->
      <section class="partidos partidos_2">
        <div class="container">
          <h1 class="partidos__title tt-2">
            Partidos
          </h1>
          <ul class="partidos__list partidos__list_2">
            <li class="partidos-item">
              <div class="partidos-item__left">
                <div class="tabl tabl_2">
                  <div class="tabl__top">
                    <div class="tabl__name tt-3">
                      Newblense
                    </div>
                    <div class="tabl__name tt-3">
                      Colo-Colo
                  ...
                  <div class="tabl__bottom">
                    <div class="tabl__score num">
                      0:0
                    </div>
                    <div class="tabl__times">
                      <div class="tabl__date">
                        26.07.2023
                      </div>
                      <div class="tabl__time">
                        01:00
                      </div>
                    </div>
                  </div>
                </div>
                <div class="partidos-item__texts">
                  <p class="partidos-item__text tx-1">
              ...
              <div class="partidos-item__image">
                <picture>
