...
<head>
  ...
  <meta property="og:title" content="Codenames es un juego fascinante alegre para la compañía de amigos. Descripción del juego">
  ...
  <meta name="twitter:title" content="Codenames es un juego fascinante alegre para la compañía de amigos. Descripción del juego">
  ...
  <meta name="description"
    content="CodeNames es un juego emocionante que combina elementos de lógica, trabajo en equipo y atención. Es adecuado para interpretar a familiares y amigos.">
  <title>Codenames es un juego fascinante alegre para la compañía de amigos. Descripción del juego</title>
...
<body>
  <div class="page">
    ...
    <main>
      <!-- start juego -->
      <section class="juego juego_2" id="about">
        <div class="container">
          <h1 class="juego__title tt-2">
            Descripción del juego
          </h1>
          <div class="juego__content">
            <div class="juego__left">
              <div class="juego__texts">
                <p class="juego__text tx-1">
          ...
          <div class="juego__content juego__content_2">
            <div class="juego__left juego__left_2">
              <div class="juego__texts">
                <p class="juego__text tx-1">
                  Además, Codenames fue uno de los primeros juegos de su género: juegos basados ​​en la comunicación y el intercambio de ideas. Fue un verdadero avance e inspiró la creación de muchos juegos similares. Su popularidad ha crecido a lo largo de los años y sigue siendo uno de los primeros y más exitosos juegos de este tipo.
                </p>
                <p class="juego__text tx-1"> 
                  Con todo, Codenames es seguro, uno de los mejores y primeros juegos de mesa que puede brindar diversión y entretenimiento a todos los jugadores, independientemente de su edad o experiencia de juego.
                </p> 
              </div> 
            </div>
            <div class="juego__image juego__image_2">
              <picture>
                <source media="(min-width: 320px)" srcset="./img/juego-2.webp" type="image/webp">
                <img src="./img/juego-2.png" loading="lazy" width="300" height="300" alt="Image">
              </picture>
            </div>
          </div>
        </div>
