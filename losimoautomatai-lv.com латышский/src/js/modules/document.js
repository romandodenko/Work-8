...
const atsauksmesContainer = document.querySelector(".atsauksmes__container");

const atsauksmesLink = document.querySelector(".atsauksmes__link");

const gamesContainer = document.querySelector(".games__container");

const gamesLink = document.querySelector(".games__link");

if (atsauksmesContainer && atsauksmesLink) {

  if (document.body.clientWidth < 992) {
    atsauksmesContainer.append(atsauksmesLink);
  }

}

if (gamesContainer && gamesLink) {

  if (document.body.clientWidth < 992) {
    gamesContainer.append(gamesLink);
  }
