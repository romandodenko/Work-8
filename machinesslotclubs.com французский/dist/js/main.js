...
const joculuiLeft = document.querySelector(".jocului__left");

const joculuiLink = document.querySelector(".jocului__link");

if (joculuiLeft) {
  if (document.body.clientWidth < 992 && joculuiLink) {
    joculuiLeft.append(joculuiLink);
  }
}
