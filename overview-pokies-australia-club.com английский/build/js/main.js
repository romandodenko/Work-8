...
const tournamentContainer = document.querySelector(".tournament__container");

const tournamentLink = document.querySelector(".tournament__link");

if (tournamentContainer) {
  if (document.body.clientWidth < 992) {
    if (tournamentLink) {
      tournamentContainer.append(tournamentLink);
    }
  }
}
