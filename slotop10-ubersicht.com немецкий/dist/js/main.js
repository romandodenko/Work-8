...
const streichContainer = document.querySelector(".streich__container");

const streichLink = document.querySelector(".streich__link");

if (streichContainer) {
  if (streichLink) {
    if (document.body.clientWidth < 992) {
      streichContainer.append(streichLink);
    }
  }
}
