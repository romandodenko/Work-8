...
const atsiliepimaiSliderInit = document.querySelector(".atsiliepimai-slider-init");

if (atsiliepimaiSliderInit) {
  const atsiliepimaiSlider = new Swiper('.atsiliepimai-slider-init', {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 1,
    ...
    pagination: {
      el: '.atsiliepimai-slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.atsiliepimai-slider-next',
      prevEl: '.atsiliepimai-slider-prev',
    },
  });
}
